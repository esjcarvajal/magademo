      ...
      <div className="healthcare-container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-up">
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">Una <span className="text-accent">Sonrisa sana   </span> embellece tu rostro                
            </h1>
